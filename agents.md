...
When creating content, use the components, models, services, and utils folders to contain work. Prefer to split into files by functional area/feature rather.
